...
- **Starter Package $9** — priority triage: the 5 most important findings to fix, within 48h (usually 24)  
- **Full Package $29** — comprehensive audit: up to 20 findings + cross-user data check + Quick Start Guide PDF, within 24h (usually 12)  
