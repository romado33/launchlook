...
> **Building the form?** Use **[`docs/TALLY-INTAKE-PASTE.txt`](../docs/TALLY-INTAKE-PASTE.txt)** in Tally’s manual editor (plain text between `>>> PASTE START` / `<<< PASTE END`). Do not paste markdown. This file is the technical reference.
...
- Single page, 15 fields (including required safety checkbox before Submit)
- Mobile-friendly (Tally is by default)
- Required vs. optional clearly marked
- Conditional fields (test accounts) only appear for Full Package ($29) tier
...
### 9. Can we use test accounts? *(Full Package only)*
- Type: Multiple choice (single select)
- Required: yes (conditional on Q8 being Full Package)
- Show only if: Q8 = "Full Package ($29)"
- Options:
...
### 12. Your support email *(Full Package only)*
- Type: Email
...
### 15. Safe submission confirmation *(required — place just above Submit)*
- Type: Checkbox
- Required: yes
- Label: **I confirm I am submitting only temporary test credentials (if any) and no sensitive production data** — no personal passwords, admin credentials, API keys, database credentials, real customer data, health data, children's data, or payment information.
