...
- You built in **Lovable / Bolt / Cursor** and need to know if signup, email, and mobile will embarrass you.
- You want a **known PDF format** and builder fix text without negotiating scope in chat.
- You already paid for a generic audit PDF and want workflow proof (silent forms are #1).
