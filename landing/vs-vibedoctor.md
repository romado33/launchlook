...
- You have a **GitHub repo** and want secrets, CVEs, SQL injection patterns, god files, and hallucinated imports caught fast.
- You want a **score that tracks over time** on every push.
- You are comfortable with file paths and line numbers.
