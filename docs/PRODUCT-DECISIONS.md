...
- **Recorded Loom walkthrough.** Rob walks the buyer through the report and the top three fixes. Pro only. Not live; not a Founder Roast (see §3). **Duration conflict to resolve:** this doc says "5 to 10 minutes" but the landing page has previously said "30-min". Canonical customer-facing copy currently reads "Rob walks you through the report on video" — Rob to confirm duration and update both here and the landing cards before the next audit is delivered.
