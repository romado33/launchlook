...
- [ ] **NEW (May 26):** new Payment Links at $19 / $49 / $99 + $19 Saboteur standalone + $9 Saboteur repeat + $49 Handoff add-on + $9 Verified re-verify. Tracked in `docs/MANUAL-APPROVAL-2026-05-26.md` — autonomous worker captured the inventory and created what was missing.
