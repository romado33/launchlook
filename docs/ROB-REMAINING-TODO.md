...
**Manual editor only:** [`TALLY-INTAKE-PASTE.txt`](TALLY-INTAKE-PASTE.txt) (all questions + thank-you) · [`TALLY-INTAKE-SETUP.md`](TALLY-INTAKE-SETUP.md)

- [ ] Create form at [tally.so](https://tally.so) → Start from scratch → paste from **TALLY-INTAKE-PASTE.txt**
...
| Tally manual paste | [`TALLY-INTAKE-PASTE.txt`](TALLY-INTAKE-PASTE.txt) |
